# Proyecto - Expresión Posfija

El alumno debe implementar la clase Posfija para evaluar una expresión posfija
...
Proporcione una expresión posfija:7 4 -3 * 1 5 + / *

El resultado de 7 4 -3 * 1 5 + / * es: -14
```
